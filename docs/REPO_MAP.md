...
docs/ENGINEERING_CONTRACT.md                 CAOSCare-specific engineering doctrine (Michael-directed sections recorded verbatim ahead of the full contract): the canonical operational service-layer architecture (2026-09-20) — one canonical service layer, ActorContext/authorization, event_log-vs-receipt boundary, canonical escalation authority, simulation provenance, and the binding no-simulator-writes GATE. See docs/reports/2026-09-20-operational-workflow-audit.md for the evidence trail. (The file-size/modularity rule itself moved to AGENTS.md's "Change discipline" section 2026-09-21 — see that file, not here.)
